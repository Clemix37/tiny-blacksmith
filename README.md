...
If you're concerned about running the .exe file locally try uploading it on VirusTotal and you'll be relieved.

## Game Menu

![Game Menu](Assets/Images/tiny-blacksmith-game-menu-art.png)
...
Thank you for the time you took to look at this tiny project i built, this means a lot for me.  
Have fun coding !

![Delivery](Assets/game-icon.png)
